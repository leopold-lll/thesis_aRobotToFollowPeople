...
\usepackage{plain}
\usepackage{setspace}
\usepackage[paperheight=29.7cm,paperwidth=21cm,outer=2cm,inner=3cm,top=2.5cm,bottom=2.5cm]{geometry} % per definizione layout
...
\lstset{
	...
	commentstyle=\color{teal}, %Indica il colore dei commenti
	...
	keywordstyle = [2]{\color{darkgray}},   %custom functions 
	keywordstyle = [3]{\color{olive}},    	%variables
	keywordstyle = [4]{\color{purple}},   	%for variables
	otherkeywords= {language_functions}, 	%addition keywords to the normal syntax
	morekeywords = [2]{custom_functions}, 
	morekeywords = [3]{variables},
	morekeywords = [4]{for_variables}
}
...
\begin{document}
	...
	\begingroup
		...
		%
		\input{0-acronyms}		\clearpage
		\input{1-summary}		\clearpage
		\input{2-introduction}	\clearpage
		\input{3-detection}		\clearpage
		\input{4-tracking}		\clearpage
		\input{5-recognition}	\clearpage
		\input{6-solution}		\clearpage
		\input{7-conclusions}	\clearpage
