...
\begin{document}
	...
	\begingroup
		...
		\input{0-summary}		\clearpage
		\input{1-introduction}	\clearpage
		\input{2-detection}		\clearpage
		\input{3-tracking}		\clearpage
		\input{4-recognition}	\clearpage
		\input{5-solution}		\clearpage
		\input{6-conclusions}	\clearpage
